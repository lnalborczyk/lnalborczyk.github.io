...
date: '28.06.2021 <br><br> `r icon::fa("twitter")` <a href="https://twitter.com/lnalborczyk" style="color:white;">@lnalborczyk</a> `r icon::fa("link")` Slides available at <a href="https://tinyurl.com/marguerite" style="color:white;"> tinyurl.com/marguerite </a>'
output:
...
The materials of my 2020 doctoral course "Introduction à la modélisation statistique bayésienne" (in French, [slides + code](https://github.com/lnalborczyk/IMSB2020)).
...
* **The brms package**: Bayesian equivalent of `lme4` (but way more flexible), providing an interface to the probabilistic language `Stan`. Allows fitting complex non-linear multilevel models.

<br>

`r icon::fa("twitter")` &nbsp; [<font>lnalborczyk</font>](https://twitter.com/lnalborczyk) &nbsp; `r icon::fa("github")` &nbsp; [<font>lnalborczyk</font>](https://github.com/lnalborczyk) &nbsp; `r icon::ai("osf")` &nbsp; [<font>https://osf.io/ba8xt</font>](https://osf.io/profile/) &nbsp; `r icon::fa("globe-americas")` &nbsp; [<font>www.barelysignificant.com</font>](http://www.barelysignificant.com)
