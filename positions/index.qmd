...
There are currently no officially advertised postdoctoral positions, but you are welcome to contact me at any time to discuss potential opportunities. Researchers currently based outside France may also consider applying to join my team through an [MSCA Postdoctoral Fellowship](https://marie-sklodowska-curie-actions.ec.europa.eu/actions/postdoctoral-fellowships) (annual deadline usually around September) or a [Fyssen Foundation postdoctoral fellowship](https://www.fondationfyssen.fr/en/study-grants/aim-award/) (annual deadline usually around March).

-->

A postdoctoral position is expected to open in 2028-2029 as part of the ANR-funded INNERSPEECH project to develop a neurocomputational model of inner speech format and development.

You are also welcome to contact me at any time to discuss other potential opportunities. Researchers currently based outside France may, for example, consider applying to join my team through an [MSCA postdoc grant](https://marie-sklodowska-curie-actions.ec.europa.eu/actions/postdoctoral-fellowships) (annual deadline usually around September) or a [Fyssen postdoc grant](https://www.fondationfyssen.fr/en/study-grants/aim-award/) (annual deadline usually around March).

## PhD positions

<!--

We are seeking PhD candidates to join the ANR-funded INNERSPEECH project, with an expected start date in late 2026 or early 2027. The project will investigate the cognitive and neural mechanisms underlying the diversity of inner speech experiences through behavioural, EEG, MEG, and 7T fMRI studies.

You are also welcome to contact me at any time to discuss other potential PhD opportunities.

-->

There are currently no officially advertised PhD position, but you are welcome to contact me at any time to discuss potential opportunities (e.g., applying to the doctoral school).
...
::: {.callout-note icon=false collapse="true"}
## Investigating the impact of inner speech diversity on the representation of (external) speech sounds (5-6 months)
...
::: {.callout-note icon=false collapse="true"}
## Multilevel Bayesian modelling of spatio-temporal M/EEG data (5-6 months)
...
- Developing a computationally-efficient spatiotemporal Bayesian GAMM or GP (e.g., sparse or low-rank spatial bases) in `R`
...
- Writing the thesis and documenting the modelling framework in the `neurogam R` package (<https://lnalborczyk.github.io/neurogam/>)

**Student profile**

M2 student in statistics, informatics, data science, computational statistics, or applied mathematics, with interest in Bayesian modelling, cognitive neuroscience, and M/EEG signals. Strong programming skills in `R` is a must, and experience in software development is a plus.
...
**Computer tools**: R, Stan, brms

**Key-words**: Bayesian Modelling, Computational Statistics, Cognitive Neuroscience, M/EEG
:::
